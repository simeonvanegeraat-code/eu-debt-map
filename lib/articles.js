...
export const articles = [
  ...
  body: `
    <p class="tag">This explainer uses simple language so high school students can follow along.</p>

    <figure style="max-width:960px;margin:16px auto;">
      <img
      ...
      <figcaption style="font-size:0.9rem;opacity:0.8;text-align:center;margin-top:6px;">
        Placeholder image — add your diagram or infographic here.
      </figcaption>
    </figure>
