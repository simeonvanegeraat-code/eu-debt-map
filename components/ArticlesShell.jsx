...
export default function ArticlesShell({
  articles,
  initialTag = "All",
  initialQ = "",
}) {
  ...
  const filtered = useMemo(() => {
    ...
    return rest.filter((a) => {
      ...
      const hay = `${a.title} ${a.excerpt || a.summary || ""} ${(a.tags || []).join(
        " "
      )}`.toLowerCase();
    ...
    <main className="container" style={{ display: "grid", gap: 16 }}>
      ...
      <section className="card" style={{ paddingTop: 18, paddingBottom: 18 }}>
        ...
        <p className="tag" style={{ marginTop: 6 }}>
          Explainers and insights built on the same Eurostat data as our live
          map.
        </p>
      </section>
