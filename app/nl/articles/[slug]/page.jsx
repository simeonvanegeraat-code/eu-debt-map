...
export async function generateMetadata({ params }) {
  ...
  return buildArticleMetadata({
    ...
    missingTitle: "Artikel • EU Debt Map",
      ...
      <article className="article-container" lang={article.lang}>
        <header>
          <div className="metaRow">
            ...
            {article.author && (
              <span>
                door {typeof article.author === "string" ? article.author : article.author.name}
              </span>
            )}
          </div>
          ...
          {article.summary && <div className="summary-lead">{article.summary}</div>}
        </header>
