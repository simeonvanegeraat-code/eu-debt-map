...
export const metadata = {
  title:
    "EU Schuldinzichten: artikelen, data-analyses en uitleg • EU Debt Map",
  description:
    "Lees data-gedreven artikelen, uitleg en updates over EU-staatsschuld, schuld ten opzichte van bbp, landenontwikkelingen, begrotingsregels en Eurostat-data.",
  alternates: {
  ...
  openGraph: {
    title:
      "EU Schuldinzichten: artikelen, data-analyses en uitleg • EU Debt Map",
    description:
      "Ontdek data-gedreven artikelen en uitleg over EU-staatsschuld, schuld/bbp, begrotingsregels en schuldtrends per land.",
  ...
  twitter: {
    ...
    title: "EU Schuldinzichten • EU Debt Map",
    description:
      "Data-gedreven artikelen, uitleg en updates over staatsschuld in de EU-27.",
  },
};
...
export default function ArticlesPage() {
  ...
  return (
    <div className="insights-page">
      ...
      >
        <div>
          <div className="hero-eyebrow">EU Debt Map onderzoek</div>
          <h1 id="insights-title">EU Schuldinzichten</h1>
          <p>
            Data-gedreven artikelen, uitleg en updates over staatsschuld,
            schuld ten opzichte van bbp, landenrisico en fiscale druk binnen
            de EU-27.
          </p>

          <div className="hero-actions" aria-label="Verken EU Debt Map">
            <Link href="/nl" className="hero-btn primary">
              Bekijk de live kaart
            </Link>
            <Link href="/nl/debt-to-gdp" className="hero-btn">
              Bekijk schuld/bbp
            </Link>
            <Link href="/nl/methodology" className="hero-btn">
              Lees de methode
            </Link>
          </div>
        </div>

        <aside className="hero-panel" aria-label="Wat je hier vindt">
          <p className="hero-panel-title">Wat je hier vindt</p>
          <ul className="hero-panel-list">
            <li>Duidelijke uitleg over staatsschuld en schuld ten opzichte van bbp.</li>
            <li>Landgerichte verhalen op basis van EU-27 schulddata.</li>
            <li>Updates wanneer nieuwe Eurostat-cijfers het beeld veranderen.</li>
          </ul>
        </aside>
      </section>
        ...
        >
          <Link href={hrefForArticle(topStory)} className="top-story">
            ...
            <div className="top-story-content">
              <span className="story-kicker">Hoofdverhaal</span>
              ...
              <span className="top-story-cta">Lees analyse</span>
            </div>
          </Link>

          <div className="side-stories">
            <SmallStoryCard article={secondStory} label="Laatste update" />
            <SmallStoryCard article={thirdStory} label="Uitleg" />
          </div>
        </section>
      )}
      ...
      <section className="insights-shell topics-section" aria-labelledby="topics-title">
        <div className="section-head">
          <div>
            <h2 id="topics-title">Verken per onderwerp</h2>
            <p>
              Volg de belangrijkste thema’s achter de Europese schuldontwikkeling,
              van landenranglijsten tot begrotingsregels en Eurostat-updates.
            </p>
          </div>
        </div>
        ...
        <div className="topics-grid">
          <TopicCard
            href="/nl/articles"
            label="EU-schuldoverzicht"
            text="Het grote beeld van overheidsschuld binnen de EU-27."
          />
          <TopicCard
            href="/nl"
            label="Schuld per land"
            text="Start met de live kaart en vergelijk staatsschuld per land."
          />
          <TopicCard
            href="/nl/debt-to-gdp"
            label="Schuld/bbp"
            text="Bekijk schuld in verhouding tot de omvang van de economie."
          />
          <TopicCard
            href="/nl/debt"
            label="Schuld uitgelegd"
            text="Simpele uitleg voor lezers die nieuw zijn in staatsschuld."
          />
          <TopicCard
            href="/nl/methodology"
            label="Eurostat-data"
            text="Hoe officiële data wordt omgezet naar live schattingen."
          />
        </div>
      </section>
      ...
      <section className="insights-shell latest-section" aria-labelledby="latest-title">
        <div className="section-head">
          <div>
            <h2 id="latest-title">Laatste artikelen</h2>
            <p>
              Lees de nieuwste EU Debt Map verhalen, uitleg en data-gedreven
              analyses.
            </p>
          </div>
        </div>
      ...
      >
        <div className="reports-intro">
          <h2 id="reports-title">Verdiepende datarapporten</h2>
          <p>
            Sommige pagina’s zijn diepere onderzoeksweergaven in plaats van
            normale artikelen. Gebruik deze wanneer je grafieken, ranglijsten
            en methodiek wilt bekijken.
          </p>
        </div>
        ...
        <div className="reports-grid">
          <Link href="/eu-debt" className="report-card">
            <span>
              ...
              <span>
                Engelstalig verdiepend rapport over totale EU-schuld, landenverdeling
                en ontwikkeling door de tijd.
              </span>
            </span>
            <span className="report-arrow">→</span>
          </Link>

          <Link href="/nl/debt-to-gdp" className="report-card">
            <span>
              <strong>Schuld/bbp-ranglijst</strong>
              <span>
                Vergelijk staatsschuld met de omvang van de economie per land.
              </span>
            </span>
            <span className="report-arrow">→</span>
          </Link>

          <Link href="/nl/methodology" className="report-card">
            <span>
              <strong>Methodologie en databronnen</strong>
              <span>
                Bekijk hoe EU Debt Map Eurostat-data en live schattingen gebruikt.
              </span>
            </span>
            <span className="report-arrow">→</span>
          </Link>
      ...
      >
        <h2 id="about-insights-title">Over EU Schuldinzichten</h2>
        <p>
          EU Schuldinzichten is het redactionele deel van EU Debt Map. Hier leggen
          we staatsschuld, schuld ten opzichte van bbp, begrotingsregels en
          schuldtrends per land uit met transparante Eurostat-data en berekeningen
          van EU Debt Map. Voor het live overzicht begin je bij de{" "}
          <Link href="/nl">interactieve EU-schuldenkaart</Link>. Voor de
          berekening lees je onze <Link href="/nl/methodology">methodologie</Link>.
        </p>
      </section>
    </div>
  );
