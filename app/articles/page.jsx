...
export const metadata = {
  title:
    "EU Debt Insights: Articles, Data Analysis and Explainers • EU Debt Map",
  description:
    "Read data-backed articles, explainers and updates on EU government debt, debt-to-GDP, country debt trends, fiscal rules and Eurostat data across the EU-27.",
  alternates: {
  ...
  openGraph: {
    title:
      "EU Debt Insights: Articles, Data Analysis and Explainers • EU Debt Map",
    description:
      "Explore data-backed articles and explainers on EU government debt, debt-to-GDP, fiscal rules and country debt trends.",
  ...
  twitter: {
    ...
    title: "EU Debt Insights • EU Debt Map",
    description:
      "Data-backed articles, explainers and updates on government debt across the EU-27.",
  },
};
...
function tagForArticle(article, fallback = "Analysis") {
...
export default function ArticlesPage() {
  ...
  return (
    <div className="insights-page">
      ...
      >
        <div>
          <div className="hero-eyebrow">EU Debt Map research</div>
          <h1 id="insights-title">EU Debt Insights</h1>
          <p>
            Data-backed articles, explainers and updates on government debt,
            debt-to-GDP, country risk and fiscal pressure across the EU-27.
          </p>

          <div className="hero-actions" aria-label="Explore EU Debt Map">
            <Link href="/" className="hero-btn primary">
              Explore the live map
            </Link>
            <Link href="/debt-to-gdp" className="hero-btn">
              View debt-to-GDP
            </Link>
            <Link href="/methodology" className="hero-btn">
              Read the methodology
            </Link>
          </div>
        </div>

        <aside className="hero-panel" aria-label="What this section covers">
          <p className="hero-panel-title">What you will find here</p>
          <ul className="hero-panel-list">
            <li>Clear explanations of public debt and debt-to-GDP.</li>
            <li>Country-focused stories based on EU-27 debt data.</li>
            <li>Updates when new Eurostat figures change the picture.</li>
          </ul>
        </aside>
      </section>
        ...
        >
          <Link href={hrefForArticle(topStory)} className="top-story">
            ...
            <div className="top-story-content">
              <span className="story-kicker">Top story</span>
              ...
              <span className="top-story-cta">Read analysis</span>
            </div>
          </Link>

          <div className="side-stories">
            <SmallStoryCard article={secondStory} label="Latest update" />
            <SmallStoryCard article={thirdStory} label="Explainer" />
          </div>
        </section>
      )}
      ...
      <section className="insights-shell topics-section" aria-labelledby="topics-title">
        <div className="section-head">
          <div>
            ...
            <p>
              Follow the main themes behind Europe’s debt story, from country
              rankings to fiscal rules and Eurostat data releases.
            </p>
          </div>
        </div>
        ...
        <div className="topics-grid">
          <TopicCard
            href="/articles"
            label="EU debt overview"
            text="Big-picture analysis of public debt across the EU-27."
          />
          <TopicCard
            href="/"
            label="Debt by country"
            text="Start with the live map and compare national debt levels."
          />
          <TopicCard
            href="/debt-to-gdp"
            label="Debt-to-GDP"
            text="Understand debt pressure relative to economic size."
          />
          <TopicCard
            href="/debt"
            label="Debt explained"
            text="Simple explainers for readers new to government debt."
          />
          <TopicCard
            href="/methodology"
            label="Eurostat data"
            text="How official data becomes live debt estimates."
          />
        </div>
      </section>
      ...
      <section className="insights-shell latest-section" aria-labelledby="latest-title">
        <div className="section-head">
          <div>
            ...
            <p>
              Read the newest EU Debt Map stories, explainers and data-backed
              analysis.
            </p>
          </div>
        </div>
      ...
      >
        <div className="reports-intro">
          <h2 id="reports-title">Special data reports</h2>
          <p>
            Some pages are deeper research views rather than normal articles.
            Use these when you want charts, rankings and methodology instead
            of a short editorial story.
          </p>
        </div>
        ...
        <div className="reports-grid">
          <Link href="/eu-debt" className="report-card">
            <span>
              ...
              <span>
                A deeper view of total EU debt, country shares and long-term movement.
              </span>
            </span>
            <span className="report-arrow">→</span>
          </Link>

          <Link href="/debt-to-gdp" className="report-card">
            <span>
              <strong>Debt-to-GDP rankings</strong>
              <span>
                Compare government debt relative to the size of each economy.
              </span>
            </span>
            <span className="report-arrow">→</span>
          </Link>

          <Link href="/methodology" className="report-card">
            <span>
              <strong>Methodology and data sources</strong>
              <span>
                See how EU Debt Map uses Eurostat data and live estimates.
              </span>
            </span>
            <span className="report-arrow">→</span>
          </Link>
      ...
      >
        <h2 id="about-insights-title">About EU Debt Insights</h2>
        <p>
          EU Debt Insights is the editorial section of EU Debt Map. It explains
          public debt, debt-to-GDP, fiscal rules and country-level debt trends
          using transparent Eurostat data and EU Debt Map calculations. For the
          live overview, start with the <Link href="/">interactive EU debt map</Link>.
          For calculation details, read our <Link href="/methodology">methodology</Link>.
        </p>
      </section>
    </div>
  );
