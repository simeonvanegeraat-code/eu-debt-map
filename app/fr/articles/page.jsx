...
export const metadata = {
  title:
    "Analyses de la dette de l’UE : articles, données et explications • EU Debt Map",
  description:
    "Lisez des articles, explications et mises à jour fondés sur les données concernant la dette publique de l’UE, le ratio dette/PIB, les tendances par pays, les règles budgétaires et les données Eurostat.",
  alternates: {
  ...
  openGraph: {
    title:
      "Analyses de la dette de l’UE : articles, données et explications • EU Debt Map",
    description:
      "Découvrez des articles et explications fondés sur les données concernant la dette publique de l’UE, le ratio dette/PIB, les règles budgétaires et les tendances par pays.",
  ...
  twitter: {
    ...
    title: "Analyses de la dette de l’UE • EU Debt Map",
    description:
      "Articles, explications et mises à jour fondés sur les données concernant la dette publique dans l’UE-27.",
  },
};
...
export default function ArticlesPage() {
  ...
  const jsonLd = {
    ...
    "@type": "CollectionPage",
    name: "Analyses de la dette de l’UE",
    description:
      "Articles, explications et mises à jour fondés sur les données concernant la dette publique dans l’UE-27.",
    url: `${SITE}${prefix}/articles`,
    isPartOf: {
  ...
  return (
    <div className="insights-page">
      ...
      >
        <div>
          <div className="hero-eyebrow">Recherche EU Debt Map</div>
          <h1 id="insights-title">Analyses de la dette de l’UE</h1>
          <p>
            Articles, explications et mises à jour fondés sur les données
            concernant la dette publique, le ratio dette/PIB, le risque par pays
            et la pression budgétaire dans l’UE-27.
          </p>

          <div className="hero-actions" aria-label="Explorer EU Debt Map">
            <Link href="/fr" className="hero-btn primary">
              Voir la carte en direct
            </Link>
            <Link href="/fr/debt-to-gdp" className="hero-btn">
              Voir dette/PIB
            </Link>
            <Link href="/fr/methodology" className="hero-btn">
              Lire la méthodologie
            </Link>
          </div>
        </div>

        <aside className="hero-panel" aria-label="Ce que vous trouverez ici">
          <p className="hero-panel-title">Ce que vous trouverez ici</p>
          <ul className="hero-panel-list">
            <li>Des explications claires sur la dette publique et le ratio dette/PIB.</li>
            <li>Des analyses par pays fondées sur les données de dette de l’UE-27.</li>
            <li>Des mises à jour lorsque les nouvelles données Eurostat changent le tableau.</li>
          </ul>
        </aside>
      </section>
      ...
      {topStory && (
        <section
          ...
          aria-label="Articles mis en avant"
        >
          <Link href={hrefForArticle(topStory)} className="top-story">
            ...
            <div className="top-story-content">
              <span className="story-kicker">Article principal</span>
              ...
              <span className="top-story-cta">Lire l’analyse</span>
            </div>
          </Link>

          <div className="side-stories">
            <SmallStoryCard article={secondStory} label="Dernière mise à jour" />
            <SmallStoryCard article={thirdStory} label="Explication" />
          </div>
        </section>
      )}
      ...
      <section className="insights-shell topics-section" aria-labelledby="topics-title">
        <div className="section-head">
          <div>
            <h2 id="topics-title">Explorer par sujet</h2>
            <p>
              Suivez les grands thèmes derrière l’évolution de la dette en Europe,
              des classements par pays aux règles budgétaires et aux données Eurostat.
            </p>
          </div>
        </div>
        ...
        <div className="topics-grid">
          <TopicCard
            href="/fr/articles"
            label="Vue d’ensemble de la dette"
            text="Le tableau général de la dette publique dans l’UE-27."
          />
          <TopicCard
            href="/fr"
            label="Dette par pays"
            text="Commencez avec la carte en direct et comparez les pays."
          />
          <TopicCard
            href="/fr/debt-to-gdp"
            label="Dette/PIB"
            text="Analysez la dette par rapport à la taille de l’économie."
          />
          <TopicCard
            href="/fr/debt"
            label="Dette expliquée"
            text="Des explications simples pour les lecteurs nouveaux sur ce sujet."
          />
          <TopicCard
            href="/fr/methodology"
            label="Données Eurostat"
            text="Comment les données officielles deviennent des estimations en direct."
          />
        </div>
      </section>
      ...
      <section className="insights-shell latest-section" aria-labelledby="latest-title">
        <div className="section-head">
          <div>
            ...
            <p>
              Lisez les derniers articles, explications et analyses fondés sur
              les données d’EU Debt Map.
            </p>
          </div>
        </div>
      ...
      >
        <div className="reports-intro">
          <h2 id="reports-title">Rapports de données approfondis</h2>
          <p>
            Certaines pages sont des vues de recherche plus complètes plutôt
            que des articles classiques. Utilisez-les pour les graphiques, les
            classements et la méthodologie.
          </p>
        </div>
        ...
        <div className="reports-grid">
          <Link href="/eu-debt" className="report-card">
            <span>
              ...
              <span>
                Rapport en anglais sur la dette totale de l’UE, la répartition
                par pays et l’évolution à long terme.
              </span>
            </span>
            <span className="report-arrow">→</span>
          </Link>

          <Link href="/fr/debt-to-gdp" className="report-card">
            <span>
              <strong>Classement dette/PIB</strong>
              <span>
                Comparez la dette publique à la taille de chaque économie.
              </span>
            </span>
            <span className="report-arrow">→</span>
          </Link>

          <Link href="/fr/methodology" className="report-card">
            <span>
              <strong>Méthodologie et sources de données</strong>
              <span>
                Découvrez comment EU Debt Map utilise Eurostat et les estimations en direct.
              </span>
            </span>
            <span className="report-arrow">→</span>
          </Link>
      ...
      >
        <h2 id="about-insights-title">À propos des analyses de la dette de l’UE</h2>
        <p>
          Les analyses de la dette de l’UE constituent la section éditoriale
          d’EU Debt Map. Nous y expliquons la dette publique, le ratio dette/PIB,
          les règles budgétaires et les tendances par pays à partir de données
          Eurostat transparentes et des calculs d’EU Debt Map. Pour la vue en
          direct, commencez avec la{" "}
          <Link href="/fr">carte interactive de la dette européenne</Link>. Pour
          les calculs, consultez notre{" "}
          <Link href="/fr/methodology">méthodologie</Link>.
        </p>
      </section>
    </div>
  );
