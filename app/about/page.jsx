...
export const metadata = {
  ...
  openGraph: {
    title: "About & Contact | EU Debt Map",
    description:
      "EU Debt Map is an independent hobby project to visualize EU-27 national debt. Contact Simeon via email for feedback or questions.",
...
export default function AboutPage() {
  ...
  return (
    <main className="container grid gap-6 py-10">
      ...
      {/* Data & Methodology verwijzing */}
      <section className="rounded-2xl border border-gray-700/50 p-6 bg-[#0b1220]/60">
        <h2 className="text-2xl font-bold">About the Project</h2>
        <p className="mt-3 text-gray-300">
          EU Debt Map is an educational visualization of government debt across the EU-27.  
          We combine the two most recent Eurostat reference periods to estimate a live, ticking total per country.  
          Our aim is to raise awareness and make complex financial data easier to grasp.
        </p>
        <p className="mt-3 text-gray-300">
      ...
      <section className="rounded-2xl border border-gray-700/50 p-6 bg-[#0b1220]/60">
        ...
        <div className="mt-5 grid gap-3 sm:grid-cols-2">
          <a
            href={`mailto:${email}`}
            className="rounded-xl border border-gray-600 px-4 py-3 text-center font-semibold hover:bg-gray-800"
          >
            Email Simeon
          </a>
          <a
