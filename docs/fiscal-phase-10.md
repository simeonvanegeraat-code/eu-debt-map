...
Release verified on 8 September 2026: `fd9f6fa3bcb4e83f9636188f82e10b0d476c9e62` was pushed to `main`. [GitHub CI run 34269591922](https://github.com/simeonvanegeraat-code/eu-debt-map/actions/runs/34269591922) and Vercel Production deployment `6335529017` succeeded. All 230 live routes returned HTTP 200. The 227 sitemap pages matched the final local metadata, Dataset/WebPage/TechArticle markup and internal links; only generated Twitter-image build hashes were normalized for comparison. The live Dutch deficit page displayed the contextual links and corrected calculation rule. No browser errors were captured; AdSense emitted a non-blocking warning about the existing `data-nscript` attribute. Advertising code was unchanged. The release evidence is retained as `eu-debt-map-phase-10-live-verification.json` and `eu-debt-map-fiscal-phase-10-live-20260908.json` in the temporary directory. This verification note was written locally after the release commit.
